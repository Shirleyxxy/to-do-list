...
/**
 * Dialog window for adding a new task.
 * 
...
public class AddTaskDialog extends JDialog {
	 ...
	 * Create the dialog.
	 */
	public AddTaskDialog(Frame owner, String title) {
	...
	/**
	 * Updates title and priority level of the new task when the user clicks done.
	 */
	private void done() {
	...
	/**
	 * Gets the priority level of the new task.
	 * 
	 * @return taskPriority
	 */
